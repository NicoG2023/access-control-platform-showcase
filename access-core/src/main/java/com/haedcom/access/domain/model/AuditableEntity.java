...
public abstract class AuditableEntity {
    ...
    public void setCreadoEnUtc(OffsetDateTime creadoEnUtc) {
        this.creadoEnUtc = creadoEnUtc;
    }
    ...
    public void setActualizadoEnUtc(OffsetDateTime actualizadoEnUtc) {
        this.actualizadoEnUtc = actualizadoEnUtc;
    }
}
